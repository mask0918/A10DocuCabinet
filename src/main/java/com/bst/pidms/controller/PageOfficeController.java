...
//        srb.addUrlMappings("/pageoffice.js");
    ...
    public ModelAndView showWord(@PathVariable("id") Integer id, HttpServletRequest request, Map<String, Object> map) {
        ...
        poCtrl.webOpen("D:\\InsightPIDMS\\zzz\\DOCUMENT\\" + fileName, openModeType, "洞见测试!!!!哈哈哈哈");
...
//        return poCtrl.getHtmlCode("PageOfficeCtrl1");
    ...
    public void saveFile(@PathVariable("id") Integer id, HttpServletRequest request, HttpServletResponse response) {
        FileSaver fs = new FileSaver(request, response);
        //保存文件
        String fileName = ownFileService.getFileById(id).getName();
        fs.saveToFile("D:\\InsightPIDMS\\zzz\\DOCUMENT\\" + fileName);
        fs.close();
    }
